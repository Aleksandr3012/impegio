...
function eventHandler() {
	...
	var wipeAnimation = new TimelineMax()
		.fromTo(".sAbout__slide.slide-1", .1, {opacity: 1}, { opacity: 1})  // in from left
		.fromTo(".sAbout__slide.slide-2", .1, {opacity: 0}, { opacity: 1})  // in from left
		.fromTo(".sAbout__slide.slide-3", .1, {opacity: 0}, { opacity: 1})  // in from left
		.fromTo(".sAbout__slide.slide-4", .1, {opacity: 0}, { opacity: 1})  // in from left
